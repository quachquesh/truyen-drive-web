  ...
  >
    <NSpace vertical size="large">
      ...
      <div>
        ...
        <NButton v-if="!showManual" text size="tiny" style="margin-top: 8px" @click="showManual = true">
          Dán URL / ID thủ công?
        </NButton>
        ...
        <template v-else>
          <NForm label-placement="top" :show-feedback="false" style="margin-top: 8px">
            ...
            <NButton type="primary" :loading="adding" @click="addLibrary">Thêm kho</NButton>
          </NForm>
          <NButton text size="tiny" style="margin-top: 8px" @click="showManual = false">
          ...
          <NListItem v-for="lib in libraryStore.libraries" :key="lib.id">
            <div class="lib-row">
              ...
              <NSpace size="small">
                ...
                <NButton size="tiny" quaternary type="error" @click="removeLibrary(lib.id, lib.name)">
